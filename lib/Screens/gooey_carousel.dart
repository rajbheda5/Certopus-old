...
class GooeyCarouselState extends State<GooeyCarousel>
  ...
  void initState() {
    ...
    _yellowBg = Image.asset(
      'assets/Bg-Yellow.png',
      fit: BoxFit.cover,
    );
    _redBg = Image.asset(
      'assets/Bg-Red.png',
...
class ContentCard extends StatefulWidget {
  ...
  ContentCard({this.index, this.image, this.background}) : super();
